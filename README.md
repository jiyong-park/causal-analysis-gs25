...
-	현실에서 관찰할 수 없는 반사실을 유추하기 위해서는 언제나 적절한 가정이 필요합니다. 방법론에 따라 세부적인 디테일은 다르지만, 결국 가장 중요한 가정은 실제 원인이 없던 통제집단에서의 결과가 (실제 원인이 있었지만) 만약 원인이 없었다면 있었을 처치집단에서의 결과(반사실)와 유사하고 비교가능하다는 것입니다.
